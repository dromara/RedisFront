...
public class ImportConfigDialog extends AbstractDialog<Void> {
    ...
    public static void showImportDialog() {
        var importConfigDialog = new ImportConfigDialog(Application.frame);
        importConfigDialog.setMinimumSize(new Dimension(400, 200));
        importConfigDialog.setLocationRelativeTo(Application.frame);
    ...
    private void onOk() {
        ...
        var result = fileChooser.showDialog(Application.frame, LocaleUtils.getMessageFromBundle("ConfigImport.saveBtn.title"));
