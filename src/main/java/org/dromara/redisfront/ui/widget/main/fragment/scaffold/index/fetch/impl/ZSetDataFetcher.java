...
public class ZSetDataFetcher implements DataFetcher {
    ...
    public ZSetDataFetcher(RedisConnectContext redisConnectContext, String key, Consumer<Turbo5<Long, SortedSetTableModel, String, String, Boolean>> consumer, ResourceBundle tr) {
    ...
    public void fetchData() {
        ...
        sortedSetTableModel = new SortedSetTableModel(scanContext.getKeyList());
