...
public class ConnectInfo implements Serializable, Cloneable {
    ...
    private Boolean ssl;
    private Enums.Connect connectMode;
    ...
    public ConnectInfo(String title, String host, Integer port, String username, String password, Integer database, Boolean ssl, Enums.Connect connectMode) {
        this(title, host, port, username, password, database, ssl, connectMode, null, null);
    }

    public ConnectInfo(String title, String host, Integer port, String username, String password, Integer database, Boolean ssl, Enums.Connect connectMode, SSHConfig sshConfig) {
        this(title, host, port, username, password, database, ssl, connectMode, null, sshConfig);
    }

    public ConnectInfo(String title, String host, Integer port, String username, String password, Integer database, Boolean ssl, Enums.Connect connectMode, SSLConfig sslConfig) {
    ...
    public ConnectInfo(String title, String host, Integer port, String username, String password, Integer database, Boolean ssl, Enums.Connect connectMode, SSLConfig sslConfig, SSHConfig sshConfig) {
        this.title = title;
        this.host = host;
        this.port = port;
    ...
    public Enums.Connect connectMode() {
        return connectMode;
    }

    public ConnectInfo setConnectMode(Enums.Connect connectMode) {
        this.connectMode = connectMode;
        return this;
    }
    ...
    public Enums.RedisMode redisModeEnum() {
        return redisMode;
    }
