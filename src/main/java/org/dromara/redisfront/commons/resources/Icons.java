...
public class Icons {
    ...
    public static final Icon REFRESH_ICON = new FlatSVGIcon("icons/refresh.svg",14,14);
    public static final Icon REFRESH_A_ICON = new FlatSVGIcon("icons/refresh_a.svg",16,16);
    public static final Icon DELETE_ICON = new FlatSVGIcon("icons/delete.svg",14,14);
    public static final Icon DELETE_B_ICON = new FlatSVGIcon("icons/delete_b.svg",14,14);
